...
brew install php55 --with-homebrew-curl --with-homebrew-openssl --with-fpm --with-mysql --with-pgsql
brew install php56 --with-homebrew-curl --with-homebrew-openssl --without-snmp --with-fpm --with-mysql --with-pgsql
